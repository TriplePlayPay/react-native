...
import { initStripe } from '@tripleplaypay/react-native';
...
All of the stripe functions can be imported directly from `@tripleplaypay/react-native` so that you can use them both with `class` and `functional` components.
...
```tsx
import { useConfirmPayment } from '@tripleplaypay/react-native';
...
```tsx
import { useStripe } from '@tripleplaypay/react-native';
...
```tsx
import { confirmPayment } from '@tripleplaypay/react-native';
...
```tsx
import { useApplePay } from '@tripleplaypay/react-native'
// ...
...
```tsx
import { isApplePaySupported } from '@tripleplaypay/react-native';
// ...
